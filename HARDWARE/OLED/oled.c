...
/*长*/ 0x00,0x00,0x00,0xFC,0xFC,0x7C,0x60,0x30,
0x38,0x18,0x8C,0x8C,0x84,0x80,0x80,0x00,
0x03,0x03,0x01,0x3F,0x7F,0x61,0x45,0x6D,
0x6D,0x3D,0x19,0x31,0x31,0x30,0x20,0x00,

/*春*/ 0x00,0xA8,0xA8,0xEC,0xEC,0xFC,0xBC,0xBE,0xB6,0x94,0x94,0x94,0xB4,0x84,0x84,0x00,
0x10,0x1C,0x1F,0x3F,0x7D,0x7E,0x5A,0x52,0x52,0x42,0x42,0x76,0x3F,0x3F,0x06,0x00,

/*工*/ 0x08,0x0C,0x04,0xC4,0xFC,0xFC,0x1C,0x0C,0x8C,0x8C,0x8C,0x0C,0x0C,0x08,0x08,0x00,
0x20,0x20,0x20,0x21,0x21,0x21,0x21,0x21,0x21,0x31,0x3F,0x3F,0x2E,0x20,0x20,0x00,

/*业*/ 0x00,0x00,0x00,0x00,0x00,0xF8,0xF8,0x18,0xF8,0xFC,0xFC,0x80,0x80,0x00,0x00,0x00,
0x00,0x21,0x23,0x23,0x23,0x3F,0x3F,0x20,0x3F,0x3F,0x3F,0x21,0x23,0x23,0x22,0x00,

/*大*/ 0x20,0x20,0x20,0x20,0xA0,0xE0,0xF8,0x3C,0x2E,0x26,0x20,0x20,0x20,0x20,0x20,0x00,
0x00,0x60,0x78,0x7E,0x1F,0x07,0x06,0x0C,0x0C,0x18,0x18,0x30,0x30,0x30,0x60,0x40,

/*学*/ 0x00,0xE0,0xE4,0x6C,0xFC,0xB8,0xB6,0xBE,0x9C,0x90,0x9C,0x9E,0xBE,0xF6,0xE0,0x00,
0x00,0x13,0x13,0x11,0x11,0x50,0x58,0x5C,0x7E,0x7F,0x0B,0x09,0x09,0x19,0x19,0x00
};
...
void OLED_Write(unsigned char byte_add,unsigned char wdata)//按地址写入一字节数据
{
	...
	IIC_Send_Byte(SSD1106_I2C_ADDR);//写器件地址

	IIC_Wait_Ack();

	IIC_Send_Byte(byte_add);//内部寄存器地址

	IIC_Wait_Ack();

	IIC_Send_Byte(wdata);//内部寄存器数据
...
{
	IIC_Start();
	IIC_Send_Byte(SSD1106_I2C_ADDR | 0x00);
	IIC_Wait_Ack();
	IIC_Send_Byte(0x00);
	IIC_Wait_Ack();
	IIC_Send_Byte(cmd);
